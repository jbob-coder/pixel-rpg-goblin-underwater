...
func _run() -> void:
	print("Pixel RPG Starting Area Asset Pack 006 settlement building details runtime gate")
...
func _finish() -> void:
	...
	print("This gate proves reusable presentation-only building details plus exact existing collision-body position/size parity, Gate Warden, smith, Mudcrest and first-person preservation. Device acceptance remains open.")
